...
class UpcomingBookingsScreen extends StatelessWidget {
  ...
  const UpcomingBookingsScreen({Key? key, required this.upcomingAppointments}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (item.appointmentDate != null && item.appointmentDate!.isNotEmpty) {
              try {
              ...
              children: [
                ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      CustomTextWidget(
                          text: '$formattedDate | ${item.appointmentTime ?? ''} | ${item.serviceName ?? ''}',
