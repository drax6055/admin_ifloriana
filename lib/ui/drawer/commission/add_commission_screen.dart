...
class AddCommissionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Add Commission')),
                ...
                children: [
                  Obx(() {
                    return DropdownButtonFormField<BranchModel>(
                      ...
                      items: controller.branchList.map((BranchModel branch) {
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(labelText: 'Commission Name *'),
                  ),
                  SizedBox(height: 16),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(labelText: 'Commission Type *'),
                  ),
                  SizedBox(height: 24),
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                labelText: 'Slot *', hintText: 'Ex: 1000-1999'),
