                      ...
                      GestureDetector(
                        onTap: a.paymentStatus != 'Paid'
                            ? () {
                                ...
                                controller.paymentSummaryState.tips.value = '0';
                                controller.paymentSummaryState.paymentMethod
                                    .value = 'UPI';
                                controller
                                        .paymentSummaryState.selectedTax.value =
                                    controller.taxes.isNotEmpty
                                        ? controller.taxes.first
                                        : null;
                                controller
                                    .paymentSummaryState.couponCode.value = '';
                                ...
                                Get.bottomSheet(
                                  Obx(() {
                                    ...
                                    controller.calculateGrandTotal(
                                      ...
                                      additionalDiscount: addAdditionalDiscount
                                          ? discountValue
                                          : 0.0,
